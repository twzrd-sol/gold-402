...
| [TWZRD Agent Intel](https://intel.twzrd.xyz) [![Open Source](https://img.shields.io/badge/Open_Source-2EA44F?style=plastic)](https://intel.twzrd.xyz) | Trust/Solana | Solana-native agent trust scoring via x402. Free on-chain preflight + paid signed V5 trust receipts in <1s. Only Solana-native x402 MCP trust service. |
